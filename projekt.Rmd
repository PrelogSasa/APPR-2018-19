...
graf.locevanje.skozi.leta + xlab("Leto") + ylab("Tone zbranih odpadkov") + ggtitle("Graf ločenih odpadkov po vrstah") + scale_color_discrete(name="Vrsta odpadkov", labels=c("Drugo", "Embalaža", "Papir", "Steklo"))
